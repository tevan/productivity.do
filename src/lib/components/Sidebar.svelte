<script>
  ...
  // `onsettings` was previously consumed here but settings now lives in the
   // top toolbar; App.svelte still passes the prop so we accept-and-ignore.
  let { onsettings: _onsettings = () => {}, onhelp = () => {} } = $props();
